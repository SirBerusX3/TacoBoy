...
public:
    ...
    struct RenderingOptions {
        ...
        // The largest frame the core says it can produce. The hardware-render target is
        // allocated at this size once, rather than chasing each frame's size.
        unsigned int width;
        unsigned int height;
