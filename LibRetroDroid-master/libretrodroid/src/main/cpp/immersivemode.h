...
public:
    ...
    void renderBackground(
        ...
        uintptr_t texture,
        // How much of `texture` the current frame occupies. 1,1 for a renderer that uploads
        // frames itself; less for a hardware-render target allocated at the core's maximum.
        float textureScaleX,
        float textureScaleY
    );
