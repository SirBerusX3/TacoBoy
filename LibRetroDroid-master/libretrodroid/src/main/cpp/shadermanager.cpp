...
const std::string ShaderManager::cut2UpscalePass1Vertex =
    ...
    "  c09 = (screenCoords + vec2(+0.0, +1.0)) / textureSize;\n"
    "  c10 = (screenCoords + vec2(+1.0, +1.0)) / textureSize;\n"
    // c05 addresses the render target, which is allocated at the core's maximum size;
    // previousPass is a frame-sized intermediate, so divide that scale back out.
    "  passCoords = c05 / textureScale;\n"
    "  gl_Position = vPosition;\n"
    "}";
