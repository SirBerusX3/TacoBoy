...
JNIEXPORT void JNICALL Java_com_swordfish_libretrodroid_LibretroDroid_loadAchievements(JNIEnv* env, jclass obj, jint consoleId, jintArray ids, jobjectArray memAddrDefinitions);
JNIEXPORT void JNICALL Java_com_swordfish_libretrodroid_LibretroDroid_resetAchievements(JNIEnv* env, jclass obj);
